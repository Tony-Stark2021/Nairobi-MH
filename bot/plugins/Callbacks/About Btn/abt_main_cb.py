...
async def cb_about(bot, update: CallbackQuery):
    ...
    text+=f"""\n<b><i>Bot Support:</i></b> <a href="https://t.me/movies_hub_malayalam">@movies_hub_malayalam</a>\n"""
    text+="""\n<b><i>Source Code:</i></b> <a href="https://github.com/Tony-Stark2021/Nairobi-MH">Source</a>"""

    buttons = [
        [
            InlineKeyboardButton
                (
                    "My Dev ⚡", url="https://t.me/sagar_alias_jacky"
                ),
